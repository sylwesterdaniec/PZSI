 ...
 */
public class GetLocationAdress extends AppCompatActivity {

    private static final String TAG = GetLocationAdress.class.getSimpleName();
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.get_location_adress_activity);
...
//get firebase auth instance
        ...
        authListener = new FirebaseAuth.AuthStateListener() {
            ...
            public void onAuthStateChanged(@NonNull FirebaseAuth firebaseAuth) {
                ...
                if (user == null) {
                    ...
                    startActivity(new Intent(GetLocationAdress.this, LoginActivity.class));
                    finish();
                }
  ...
  //  @SuppressWarnings("unused")
    public void fetchAddressButtonHandler(View view) {
        ...
        {
            showToast("Enable localization first!");
        }
        else
    ...
    private class   AddressResultReceiver extends ResultReceiver {
        ...
        /**
         *  Receives data sent from FetchAddressIntentService and updates the UI in GetLocationAdress.
         */
        @Override
        protected void onReceiveResult(int resultCode, Bundle resultData) {
            ...
            if (resultCode == Constants.SUCCESS_RESULT) {
                ...
                //!!!!!!!!
                senddb(mAddressOutput);
            }

            // Reset. Enable the Fetch Address button and stop showing the progress bar.
            mAddressRequested = false;
            updateUIWidgets();
            startActivity(new Intent(GetLocationAdress.this, MainPage.class));
            finish();
        }
    }
...
public void senddb(String data)

{

    mDatabase.child("users").child(uid).push().setValue(data);
}
